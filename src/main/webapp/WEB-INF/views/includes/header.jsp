    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="/board/board-list">자유게시판</a></li>
...
<header class="masthead bg-primary text-white text-center" id="grean">
    ...
    <div class="container d-flex align-items-center flex-column">
        ...
        <img src="/resources/img/mento.png" width="400" height="185"/>
        <!-- Masthead Heading-->
        <br>
        <br>
